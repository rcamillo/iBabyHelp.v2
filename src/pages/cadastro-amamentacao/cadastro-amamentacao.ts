...
export class CadastroAmamentacaoPage {
  ...
  private setupPageTitle() {
    this.title = this.navParams.data.amamentacao
      ? "Alterando mamada"
      : "Nova mamada";
  }
  ...
  createForm() {
    this.form = this.formBuilder.group({
      ...
      inicioAmamentacao: [
        this.amamentacao.inicioAmamentacao,
        Validators.required
      ],
      terminoAmamentacao: [
        this.amamentacao.terminoAmamentacao,
        Validators.required
      ],
  ...
  onSubmit() {
    if (this.form.valid) {
      this.provider
        ...
        .then(() => {
          this.toast
            .create({ message: "Mamada salva com sucesso.", duration: 3000 })
            .present();
          this.navCtrl.pop();
        })
        .catch(e => {
          this.toast
            .create({ message: "Erro ao salvar registro.", duration: 3000 })
            .present();
          console.error(e);
        });
    }
